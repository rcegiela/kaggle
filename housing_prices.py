...
def feature_engineering(df):
    ...
    feature_eng(df, cols='Electrical', defaults=Electrical_defaults, code_mappings=Electrical_code_mappings)
    ...
    feature_eng(df, cols='Functional', defaults=Functional_defaults, code_mappings=Functional_code_mappings)
    ...
    feature_eng(df, cols='Fence', defaults=Fence_defaults, code_mappings=Fence_code_mappings)
